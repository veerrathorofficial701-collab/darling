...
const DEFAULT_CONTENT = {
  ...
  gallery: {
    ...
    photos: [
      { label: 'First Date 💕', url: '/images/1783615604196-658996858_18085527137337424_8584076664170005720_n.jpg' },
      { label: 'Our Laughs 😄', url: '/images/1783615604196-658996858_18085527137337424_8584076664170005720_n.jpg' },
      { label: 'Adventures 🌍', url: '/images/1783615604196-658996858_18085527137337424_8584076664170005720_n.jpg' },
      { label: 'Special Moments ✨', url: '/images/1783615604196-658996858_18085527137337424_8584076664170005720_n.jpg' },
      { label: 'Everyday Magic 🌸', url: '/images/1783615604196-658996858_18085527137337424_8584076664170005720_n.jpg' },
      { label: 'Us, Always 💍', url: '/images/1783615604196-658996858_18085527137337424_8584076664170005720_n.jpg' },
    ],
  },
  reasons: {
  ...
  letter: {
    ...
    body: 'Happy Birthday, my love. Thank you for being the reason behind so many of my happiest moments. You have made my life brighter, more meaningful, and more beautiful simply by being a part of it. I cherish every laugh, every conversation, and every memory we create together. Today, I celebrate you and all the happiness you bring into my life.',
    sign: '— Yours, Always 💕',
  },
  wish: {
    title: 'My Birthday Wish For You 🎂',
    body: 'I wish you endless happiness, good health, success, beautiful adventures, and countless reasons to smile. May every dream in your heart find its way to reality.',
    icons: '🌸 🎂 🌟 💐 🎁 ✨',
  },
  proposal: {
    ...
    body: "You are the person who makes ordinary days feel extraordinary. You are my favorite thought, my favorite smile, and my favorite part of every day. I don't just want to celebrate your birthday with you. I want to celebrate every future birthday, every dream, every success, and every beautiful moment together. My heart chooses you today and always.",
    btn1: '💖 YES, FOREVER',
    btn2: '🥰 ABSOLUTELY YES',
  ...
  forever: {
    ...
    body: 'No matter where life takes us, my heart will always find its way back to you. Thank you for being part of my journey. Happy Birthday, my love.',
  },
